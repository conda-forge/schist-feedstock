...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/schist-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13279&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/schist-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `schist` can be installed with:

```
conda install schist
```

It is possible to list all of the versions of `schist` available on your platform with:
